...
export default {
  ...
  description:
    '「TDMボドゲ同好会」と共同制作した、ボードゲーム「いただき！お菓子パーティー」を遊べるVRChatワールド。お題に沿ってカードを出し、食べると危険なお菓子も紛れ込むなかで、集めたお菓子の数を競う。手札の読み合いをみんなで楽しめるパーティーゲームと、広いコテージやパーティー会場を模したくつろげる空間を組み合わせた。LefTonboは主にワールドギミックとワールドモデリングを担当。',
